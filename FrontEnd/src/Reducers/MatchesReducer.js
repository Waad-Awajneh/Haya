...
export const DateAndLeague = createAsyncThunk("DateAndLeague", async (data) => {
  const response = await axios.get(
    `https://apiv3.apifootball.com/?action=get_events&from=${data.from}&to=${data.To}&league_id=${data.leagueId}&APIkey=81f3c423a6c0c5ff71667bdbd97b2f9acd6b632d1f672effd14d10405ace9b42`
  );
...
export const previousMatches = createAsyncThunk(
  "previousMatches",
  async (myObject) => {
    const response = await axios.get(
      `https://apiv3.apifootball.com/?action=get_events&from=${myObject.previous}&to=${myObject.current}&league_id=${myObject.id}&APIkey=81f3c423a6c0c5ff71667bdbd97b2f9acd6b632d1f672effd14d10405ace9b42`
    );
